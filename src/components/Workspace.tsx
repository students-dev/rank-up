  ...
  return (
    <div className="h-[calc(100vh-64px)] overflow-hidden bg-zinc-950 flex flex-col font-sans text-zinc-200">
      ...
      <div className="border-t border-zinc-800 bg-zinc-900 p-4 px-6 flex justify-between items-center z-10 shadow-2xl relative">
        <button onClick={() => setShowConsole(!showConsole)} className="px-4 py-2 text-zinc-500 hover:text-white text-xs font-semibold flex items-center gap-2 transition-all group">
        ...
        <div className="flex gap-4">
          <button 
            ...
            disabled={isRunning} 
            className="px-8 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl text-xs font-semibold border border-white/5 disabled:opacity-50 flex items-center gap-2 transition-all active:scale-95 shadow-xl"
          >
          ...
          <button 
            ...
            disabled={isRunning}
            className="px-10 py-2.5 bg-orange-500 hover:bg-orange-600 text-white rounded-xl text-xs font-semibold shadow-2xl shadow-orange-500/20 flex items-center gap-2 transition-all active:scale-95"
          >
